    ...
    <div>
			...
			<div class="container-fluid">
				...
				<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
					<p class="_title0">Blog <Button icon="md-add" @click="addModal=true" >Add a New Blog</Button></p>
					...
					<div class="_overflow _table_div blog_editor">
                        ...
                        <!-- <editor header list code image linkTool :config="config"/> -->
					<div class="_input_field">
					...
					<div class="_input_field">
                        ...
                        <div class="_input_field">
                            <Input type="text" v-model="data.metaDescription" placeholder="Meta Description"/>
                        </div>
                        <div class="_input_field">
...
export default {
	...
	methods: {
        ...
        async onSave(response) {
			...
			console.log(data)
			if (res.status === 200) {
				this.success('Blog created succesfully')
