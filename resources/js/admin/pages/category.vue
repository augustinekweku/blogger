        ...
        <div class="content">
            <div class="container-fluid">
                ...
                >
                    <p class="_title0">
                        Categories
                        <Button icon="md-add" @click="addModal = true" v-if="isWritePermitted"
                            >Add Category</Button
                        >
                    </p>
                        ...
                        <table class="_table unbordered-table">
                            ...
                            >
								...
								<td class="table_image">
									<img height="40px" width="50px" :src="category.iconImage" />
								</td>
                ...
                <Modal
                    ...
                    <div slot="footer">
                        <Button type="error" @click="addModal = false"
                            >Close</Button
                        >
                        <Button
                            type="primary"
				...
				<Input
                    ...
                    <div slot="footer">
                        <Button type="error" @click="closeEditModal"
                            >Close</Button
                        >
                        <Button
                            type="primary"
    ...
    methods: {
        async addCategory() {
            ...
            if (this.data.iconImage.trim() == "")
                return this.error("iconImage is required");
