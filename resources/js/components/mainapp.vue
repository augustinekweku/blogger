                ...
                <div class="_1side_menu_content">
                    ...
                    <div class="_1side_menu_list">
                        <ul class="_1side_menu_list_ul">
                            ...
                            <li>
                            <router-link to="/role"><Icon type="ios-speedometer" />Roles</router-link>
                            </li>
                            <li>
                            <router-link to="/assignRole"><Icon type="ios-speedometer" />Role Management</router-link>
                            </li> -->
                            <li>
                            <a href="/logout"><Icon type="ios-speedometer" />Log out</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
export default {
    ...
    created() {
        ...
        console.log('stored permission: ', this.permission)
    }
